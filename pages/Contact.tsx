...
const Contact: React.FC = () => {
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    const bodyText = `Name: ${firstName} ${lastName}%0AEmail: ${email}%0ASubject: ${subject}%0AMessage: ${message}`;
    const mailto = `mailto:info@agroaerialprecision.com?subject=${encodeURIComponent('Contact form submission - ' + subject)}&body=${encodeURIComponent('Hello Agro Aerial Precision team,%0A%0A' + bodyText + '%0A%0APlease contact me soon.%0A')}`;
    const whatsappText = `Hello Agro Aerial Precision team,%0A%0A${bodyText.replace(/%0A/g, '\n')}`;
    const whatsappUrl = `https://api.whatsapp.com/send?phone=+23277840105&text=${encodeURIComponent(`Hello Agro Aerial Precision team,\n\nName: ${firstName} ${lastName}\nEmail: ${email}\nSubject: ${subject}\nMessage: ${message}\n\nPlease contact me with details.`)}`;
              ...
              <div className="space-y-8">
                ...
                <div className="flex gap-6 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400">info@aaprecision.llc</p>
                  </div>
                </div>
              </div>
